...
@section('javascript')
    ...
    @if(isset($google_analytics_client_id) && !empty($google_analytics_client_id))
        ...
        <script type="text/javascript" src="{{ voyager_asset('js/Chart.min.js') }}"></script>
<div class="row">
    ...
    grey: '#98989e'
		        ...
		        data: {
		            ...
		            [{
		                label: 'nbrclasses',
		                data: [<?php echo $data1; ?>],
		                backgroundColor: [ chartColors.blue, chartColors.info, chartColors.yellow, chartColors.grey],
		            },
